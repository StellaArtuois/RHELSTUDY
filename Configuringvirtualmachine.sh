...
virt-install --name=test1.example.com --ram=2048 --vcpus=2 --disk path=/home/guillermo/SAMSUNGEVO/KVMQEMU/tester1.example.com.qcow2,size=16,bus=virtio --graphics=spice --cdrom=/home/guillermo/SAMSUNGEVO/ISO/CentOS-7-x86_64-Minimal-1810.iso --os-type=linux --os-variant=centos7.0
